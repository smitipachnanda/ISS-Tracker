...
import { View, Text, Alert, SafeAreaView, FlatList, ImageBackground, StyleSheet, Platform, StatusBar, Dimensions} from 'react-native'
...
export default class MeteorScreen extends React.Component{
    ...
    getMeteors = ()=>{
        axios
        .get("https://api.nasa.gov/neo/rest/v1/feed?api_key = SzKHf5Rh0qYPfULD8LkHchznRgMXQxSMJLYmQinq")
        .then(response =>{
...
// 3kzNG57r4sdtCxHU8JHAUJK4t7bVxkAHO8iibjZa